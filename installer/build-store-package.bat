...
robocopy "%CD%" "%STAGE%" /E ^
  /XD .git installer dist store-assets media ^
  /XF "Install Zinra.bat" ZinraSetup.exe ZinraSetup.cs README.md BRAND.md STORE.md HANDOFF.md zinra-mark.svg privacy.html index.html demo.html entitlement.html og.svg .nojekyll settings.test.mjs ^
