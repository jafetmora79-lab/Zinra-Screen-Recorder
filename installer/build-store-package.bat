...
robocopy "%CD%" "%STAGE%" /E ^
  /XD .git installer dist store-assets ^
  /XF "Install Zinra.bat" ZinraSetup.exe ZinraSetup.cs README.md BRAND.md STORE.md HANDOFF.md zinra-mark.svg privacy.html index.html demo.html ^
